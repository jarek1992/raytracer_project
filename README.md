...
<ul style="list-style-type: none;">
  <details>
    ...
    <li><p>The engine provides a versatile lighting suite, allowing users to switch between physical sky simulations, image-based lighting, and studio backgrounds.</p></li>
    <ul> 
